...
int main(int argc, char **argv){
	...
	printf("%ld,%ld\n", ((end0.tv_sec - start0.tv_sec)*1000000000 + (end0.tv_nsec - start0.tv_nsec))*1000/iters, ((end1.tv_sec - start1.tv_sec)*1000000000 + (end1.tv_nsec - start1.tv_nsec))*1000/iters);
	return 0;
}
